# HW-w1d3 Objects and Functions



For submission, do the normal homework workflow and submission outlined in the [homework submission repo]('https://github.com/js-penguins/homework-submission').

fork, clone, **then do your work in the provided main.js file**
then add, commit, push, then open a pull request!  Don't forget the pull request, team.
