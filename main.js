...
// ~~~~~~~ your solution here: ~~~~~~~~~~~~~
user.email = "forexample@hotmail.com";
...
console.log(user.purchased.length[i])
...
console.log(user.Friend.length[i])
