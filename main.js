...
user.email = 'reno0o12345@gmail.com'
//console.log(user);
...
user.age = user.age +1;
user.friend.name = user.name.toUpperCase();
user.friend.age = user.friend.age +1;
//console.log(user);
//console.log(user.friend);
